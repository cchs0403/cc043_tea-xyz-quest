 ...
 */
const initialBaseURI = () => typeof self !== 'undefined' && self.location
    ? new URL(self.location.origin + self.location.pathname + location.search)
    : new URL('https://github.com/cfworker');
exports.initialBaseURI = initialBaseURI;
function dereference(schema, lookup = Object.create(null), baseURI = (0, exports.initialBaseURI)(), basePointer = '') {
    ...
    for (const key in schema) {
        ...
        const keyBase = `${basePointer}/${(0, pointer_1.encodePointer)(key)}`;
        ...
        if (Array.isArray(subSchema)) {
            ...
            for (const subKey in subSchema) {
                dereference(subSchema[subKey], lookup, baseURI, `${keyBase}/${(0, pointer_1.encodePointer)(subKey)}`);
            }
        }
        else {
